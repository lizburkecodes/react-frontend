    ...
    <div className="bg-white rounded shadow-lg overflow-hidden">
        ...
        <div className="px-4 pt-2 pb-4">
          ...
          <div className="mt-2 flex gap-4">
            ...
            <Link to={`/delete/${product._id}`} className="inline-block w-full text-center shadow-md text-sm bg-red-700 text-white rounded-sm px-4 py-1 font-bold hover:bg-red-600 hover:cursor-pointer">Delete</Link>
        </div>  
        </div>
    </div>
  );
